...
pub struct EqualizerDescriptorSets<A: DescriptorSetAllocator + ?Sized> {
    pub descriptor_set: Arc<PersistentDescriptorSet<A::Alloc>>,
}

impl<A: DescriptorSetAllocator + ?Sized> EqualizerDescriptorSets<A> {
    pub fn new<L>(
        polynomial: [f32; 8],
